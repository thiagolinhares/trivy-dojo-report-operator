...
DEFECT_DOJO_MINIMUM_SEVERITY = os.getenv('DEFECT_DOJO_MINIMUM_SEVERITY', "Low")
...
DEFECT_DOJO_DO_NOT_REACTIVATE = os.getenv('DEFECT_DOJO_DO_NOT_REACTIVATE', True)
DEFECT_DOJO_GROUP_BY = os.getenv('DEFECT_DOJO_GROUP_BY', "component-name")
DEFECT_DOJO_ENVIRONMENT = os.getenv('DEFECT_DOJO_ENVIRONMENT', "Lab")
DEFECT_DOJO_PRODUCT_TYPE_NAME = os.getenv('DEFECT_DOJO_PRODUCT_TYPE_NAME', "Research and Development")
DEFECT_DOJO_PRODUCT_NAME = os.getenv('DEFECT_DOJO_PRODUCT_NAME', "k8s-dojo-operator")
